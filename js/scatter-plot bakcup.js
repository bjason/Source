...
updategraph = function (axistobeupdated, givenV, givenVchanged) {
  ...
  graph = new SimpleGraph("graph", data, {
  ...
  if (axistobeupdated == "X") { X = VV; xaxis = new axis("#graph", VV, axistobeupdated, axisOptions[axistobeupdated]); }
  else { Y = VV; yaxis = new axis("#graph", VV, axistobeupdated, axisOptions[axistobeupdated]) }
};
...
updatebycb = function (axistobeupdated, selectedattr) {
  ...
  if (axistobeupdated == "X") { X = V; xaxis = new axis("#graph", V, axistobeupdated, axisOptions[axistobeupdated]); }
  else { Y = V; yaxis = new axis("#graph", V, axistobeupdated, axisOptions[axistobeupdated]); }
}
